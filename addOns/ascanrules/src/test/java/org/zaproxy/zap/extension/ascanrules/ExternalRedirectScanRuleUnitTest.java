...
class ExternalRedirectScanRuleUnitTest extends ActiveScannerTest<ExternalRedirectScanRule> {
    ...
    class ExtractJsCommentsUnitTest {
        ...
        void shouldFindExpectedComments(String name, String content, Set<String> expectedComments) {
            // Given
            String input = BODY_TEMPLATE.formatted(content);
            // When
        ...
        void shouldIdentifyMultipleComments(
            ...
            // Given
            String js = BODY_TEMPLATE.formatted(input);
            // When
            Set<String> actualComments = ExternalRedirectScanRule.extractJsComments(js);
            // Then
            assertThat(

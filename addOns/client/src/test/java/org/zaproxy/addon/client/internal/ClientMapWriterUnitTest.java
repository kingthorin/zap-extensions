        ...
        zoo.getUserObject()
                .addComponent(
                        new ClientSideComponent(
                                ...
                                zooUrl,
                                "foo",
                                ClientSideComponent.Type.LOCALSTORAGE,
                                "",
                                -1));
        zoo.getUserObject()
                .addComponent(
        ...
        zoo.getUserObject()
                .addComponent(
                        new ClientSideComponent(
                                ...
                                zooUrl,
                                "fooz",
                                ClientSideComponent.Type.SESSIONSTORAGE,
                                "",
                                -1));
        zoo.getUserObject()
                .addComponent(
        ...
        zoo.getUserObject()
                .addComponent(
                        new ClientSideComponent(
                                ...
                                "",
                                1));
        map.getOrAddNode("https://foo.bar", true, false);
        map.getOrAddNode("https://1acme.com", true, false);

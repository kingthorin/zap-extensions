...
public class ExtensionZest extends ExtensionAdaptor implements ProxyListener, ScriptEventListener {
     ...
     *     ZestScriptWrapper})
     * @param runName name for the runnable script (e.g. for logging)
     ...
     */
    public ScriptWrapper getRunnableForChain(List<ScriptWrapper> scripts, String runName) {
        ...
        return ZestScriptMerger.mergeScripts(zestWrappers, runName);
    }
